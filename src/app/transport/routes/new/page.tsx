...
import { createRoute, getVehicles, getDrivers } from '@/lib/actions/transport';
...
export default function NewRoutePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await createRoute(dataToSubmit);
      if (res.success) {
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 mt-0.5">
              Configura una nueva ruta con horarios, vehículo y paradas.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="pt-4 border-t border-slate-100 space-y-4">
              ...
              {stops.length === 0 && (
                <div className="text-center py-6 rounded-xl border-2 border-dashed border-slate-200 text-slate-400 text-sm">
                  No hay paradas agregadas. Haz clic en &ldquo;Agregar Parada&rdquo;.
                </div>
              )}
