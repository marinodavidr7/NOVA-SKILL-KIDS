          ...
          <div className="flex justify-between items-start border-b-2 border-slate-800 pb-6 mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Reporte de Inventario Actual</p>
              </div>
            </div>
          ...
          <table className="w-full text-left text-sm border-collapse mb-12">
            <thead>
              <tr className="border-b border-slate-300 bg-slate-50">
                ...
                <th className="py-3 px-4 font-semibold text-slate-800">Producto</th>
                <th className="py-3 px-4 font-semibold text-slate-800">Categoría</th>
                <th className="py-3 px-4 font-semibold text-slate-800">Stock Actual</th>
                <th className="py-3 px-4 font-semibold text-slate-800">Estado</th>
              </tr>
            </thead>
            <tbody>
